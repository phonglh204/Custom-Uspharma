    ...
    Public Class frmFilter
        ...
        Private Sub cmdOk_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdOk.Click
            If reportformlib.CheckEmptyField(Me, Me.tabReports, DirMain.oVar) Then
                If (ObjectType.ObjTst(DirMain.fPrint.CboGroupBy.SelectedValue, DirMain.fPrint.CboDetailBy.SelectedValue, False) = 0) Then
                    Msg.Alert(StringType.FromObject(DirMain.oLan.Item("905")), 2)
                Else
        ...
        Private Sub frmDirInfor_Load(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Dim vouchersearchlibobj1 As New vouchersearchlibobj(Me.txtMa_kh, Me.lblTen_kh, DirMain.sysConn, DirMain.appConn, "dmkh", "ma_kh", "ten_kh", "Customer", DirMain.strKeyCust, True, Me.cmdCancel)
            ...
            Dim vouchersearchlibobj9 As New vouchersearchlibobj(Me.txtMa_vt, Me.lblTen_vt, DirMain.sysConn, DirMain.appConn, "dmvt", "ma_vt", "ten_vt", "Item", "1=1", True, Me.cmdCancel)
            Dim vouchersearchlibobj17 As New vouchersearchlibobj(Me.txtMa_kho, Me.lblTen_kho, DirMain.sysConn, DirMain.appConn, "dmkho", "ma_kho", "ten_kho", "Store", "1=1", True, Me.cmdCancel)
            Dim vouchersearchlibobj10 As New vouchersearchlibobj(Me.txtTk_vt, Me.lblTen_Tk_vt, DirMain.sysConn, DirMain.appConn, "dmtk", "tk", "ten_tk", "Account", "1=1", True, Me.cmdCancel)
            Dim vouchersearchlibobj11 As New vouchersearchlibobj(Me.txtNh_vt, Me.lblTen_nh, DirMain.sysConn, DirMain.appConn, "Dmnhvt", "ma_nh", "ten_nh", "ItemGroup", "loai_nh=1", True, Me.cmdCancel)
            Dim vouchersearchlibobj12 As New vouchersearchlibobj(Me.txtNh_vt2, Me.lblTen_nh2, DirMain.sysConn, DirMain.appConn, "Dmnhvt", "ma_nh", "ten_nh", "ItemGroup2", "loai_nh=2", True, Me.cmdCancel)
            Dim vouchersearchlibobj13 As New vouchersearchlibobj(Me.txtNh_vt3, Me.lblTen_nh3, DirMain.sysConn, DirMain.appConn, "Dmnhvt", "ma_nh", "ten_nh", "ItemGroup3", "loai_nh=3", True, Me.cmdCancel)
            Dim vouchersearchlibobj14 As New vouchersearchlibobj(Me.txtLoai_vt, Me.lblTen_loai, DirMain.sysConn, DirMain.appConn, "Dmloaivt", "ma_loai_vt", "ten_loai_vt", "ItemType", "1=1", True, Me.cmdCancel)
            ...
            Dim vouchersearchlibobj7 As New vouchersearchlibobj(Me.txtMa_nh2, Me.lblTen_nh1, DirMain.sysConn, DirMain.appConn, "dmnhkh", "ma_nh", "ten_nh", "CustomerGroup", "loai_nh=2", True, Me.cmdCancel)
            Dim vouchersearchlibobj8 As New vouchersearchlibobj(Me.txtMa_nh3, Me.lblTen_nh1, DirMain.sysConn, DirMain.appConn, "dmnhkh", "ma_nh", "ten_nh", "CustomerGroup", "loai_nh=3", True, Me.cmdCancel)
            Dim vouchersearchlibobj16 As New vouchersearchlibobj(Me.txtMa_nx, Me.lblTen_nx, DirMain.sysConn, DirMain.appConn, "dmnx", "ma_nx", "ten_nx", "Reason", "1=1", True, Me.cmdCancel)
            Dim vouchersearchlibobj15 As New vouchersearchlibobj(Me.txtMa_vv, Me.lblTen_vv, DirMain.sysConn, DirMain.appConn, "dmvv", "ma_vv", "ten_vv", "Job", "1=1", True, Me.cmdCancel)
            Dim vouchersearchlibobj18 As New vouchersearchlibobj(Me.txtMa_dvcs, Me.lblTen_dvcs, DirMain.sysConn, DirMain.appConn, "dmdvcs", "ma_dvcs", "ten_dvcs", "Unit", "1=1", True, Me.cmdCancel)
            ...
            DirMain.oAdvFilter.InitGridOrder(DirMain.fPrint.grdOrder, DirMain.SysID, "001", (Me.ds), "Order")
            DirMain.oAdvFilter.InitGridTransCode(DirMain.fPrint.grdTransCode, "2", DirMain.cCodeSelected, (Me.ds), "TransCode")
            DirMain.oAdvFilter.AddComboboxValue(Me.CboGroupBy, DirMain.SysID, "002", (Me.ds), "GroupBy")
            DirMain.oAdvFilter.AddComboboxValue(Me.CboDetailBy, DirMain.SysID, "003", (Me.ds), "DetailBy")
            DirMain.oAdvFilter.AddComboboxValue(Me.CbbTinh_dc, DirMain.SysID, "004", (Me.ds), "Transfer")
        ...
        Private Sub InitializeComponent()
            ...
            Me.lblTen_nvbh = New Label
            Me.txtMa_nvbh = New TextBox
            ...
            Me.CboDetailBy = New ComboBox
            Me.Label12 = New Label
            Me.CboGroupBy = New ComboBox
            ...
            Me.lblTen_dvcs.Location = New Point(264, 291)
            ...
            Me.cmdOk.Location = New Point(3, 404)
            Me.cmdOk.Name = "cmdOk"
            Me.cmdOk.TabIndex = 0
            Me.cmdOk.Tag = "L001"
            Me.cmdOk.Text = "Nhan"
            Me.cmdCancel.Anchor = (AnchorStyles.Left Or AnchorStyles.Bottom)
            Me.cmdCancel.Location = New Point(79, 404)
            ...
            Me.tabReports.SelectedIndex = 0
            Me.tabReports.Size = New Size(609, 392)
            ...
            Me.tbgFilter.Controls.Add(Me.Label16)
            ...
            Me.tbgFilter.Size = New Size(601, 366)
            ...
            Me.txtNh_vt3.Location = New Point(368, 220)
            ...
            Me.txtNh_vt2.Location = New Point(264, 220)
            ...
            Me.lblTen_nvbh.Location = New Point(264, 130)
            Me.lblTen_nvbh.Name = "lblTen_nvbh"
            Me.lblTen_nvbh.Size = New Size(126, 16)
            Me.lblTen_nvbh.TabIndex = 51
            Me.lblTen_nvbh.Tag = "RF"
            Me.lblTen_nvbh.Text = "Ten nhan vien ban hang"
            Me.txtMa_nvbh.Location = New Point(160, 128)
            Me.txtMa_nvbh.Name = "txtMa_nvbh"
            Me.txtMa_nvbh.TabIndex = 9
            Me.txtMa_nvbh.Tag = "FCML"
            Me.txtMa_nvbh.Text = "txtMa_nvbh"
            Me.Label16.AutoSize = True
            Me.Label16.Location = New Point(20, 130)
            Me.Label16.Name = "Label16"
            Me.Label16.Size = New Size(105, 16)
            Me.Label16.TabIndex = 50
            Me.Label16.Tag = "L115"
            Me.Label16.Text = "Nhan vien ban hang"
            Me.txtMa_nh3.Location = New Point(368, 82)
            Me.txtMa_nh3.Name = "txtMa_nh3"
            Me.txtMa_nh3.TabIndex = 7
            Me.txtMa_nh3.Tag = "FCML"
            Me.txtMa_nh3.Text = "txtMa_nh3"
            Me.txtMa_nh2.Location = New Point(264, 82)
            ...
            Me.Label9.Location = New Point(20, 84)
            Me.Label9.Name = "Label9"
            Me.Label9.Size = New Size(97, 16)
            Me.Label9.TabIndex = 48
            Me.Label9.Tag = "L114"
            Me.Label9.Text = "Nhom khach 1-2-3"
            Me.Label7.AutoSize = True
            Me.Label7.Location = New Point(20, 222)
            Me.Label7.Name = "Label7"
            Me.Label7.Size = New Size(65, 16)
            Me.Label7.TabIndex = 45
            Me.Label7.Tag = "L111"
            Me.Label7.Text = "Nhom vat tu"
            Me.txtNh_vt.CharacterCasing = CharacterCasing.Upper
            Me.txtNh_vt.Location = New Point(160, 220)
            Me.txtNh_vt.Name = "txtNh_vt"
            Me.txtNh_vt.TabIndex = 13
            Me.txtNh_vt.Tag = "FCML"
            Me.txtNh_vt.Text = "TXTNH_VT"
            Me.Label6.AutoSize = True
            Me.Label6.Location = New Point(20, 176)
            Me.Label6.Name = "Label6"
            Me.Label6.Size = New Size(82, 16)
            Me.Label6.TabIndex = 42
            Me.Label6.Tag = "L109"
            Me.Label6.Text = "Tk vat tu (dmvt)"
            Me.txtTk_vt.CharacterCasing = CharacterCasing.Upper
            Me.txtTk_vt.Location = New Point(160, 174)
            ...
            Me.lblTen_Tk_vt.Location = New Point(264, 176)
            ...
            Me.Label8.Location = New Point(20, 199)
            ...
            Me.lblTen_vv.Location = New Point(264, 268)
            ...
            Me.lblTen_nx.Location = New Point(264, 245)
            ...
            Me.Label2.Location = New Point(20, 245)
            Me.Label2.Name = "Label2"
            Me.Label2.Size = New Size(84, 16)
            Me.Label2.TabIndex = 18
            Me.Label2.Tag = "L112"
            Me.Label2.Text = "Dang nhap xuat"
            Me.txtMa_vv.Location = New Point(160, 266)
            Me.txtMa_vv.Name = "txtMa_vv"
            Me.txtMa_vv.TabIndex = 17
            Me.txtMa_vv.Tag = "FCML"
            Me.txtMa_vv.Text = "txtMa_vv"
            Me.txtMa_nx.Location = New Point(160, 243)
            ...
            Me.lblMau_bc.Location = New Point(20, 314)
            ...
            Me.tbgOrder.Size = New Size(601, 366)
            ...
            Me.grdOrder.Size = New Size(601, 368)
            ...
            Me.tbgFree.Size = New Size(601, 366)
            ...
            Me.tbgOther.Size = New Size(601, 366)
            ...
            Me.tbgTransCode.Size = New Size(601, 366)
            ...
            Me.grdTransCode.Size = New Size(601, 368)
            Me.grdTransCode.TabIndex = 2
            Me.lblTen_nh.AutoSize = True
            Me.lblTen_nh.Location = New Point(248, 408)
            ...
            Me.lblTen_nh1.Location = New Point(184, 432)
        ...
        Friend WithEvents CboDetailBy As ComboBox
        Friend WithEvents CboGroupBy As ComboBox
