...
Module modVoucher
    ...
    Public Sub main(ByVal CmdArgs As String())
        ...
        Sys.InitMessage(modVoucher.sysConn, modVoucher.oLan, "ITTran")
    ...
    Public Const SysID As String = "ITTran"
    Public tbcDetail As DataGridTextBoxColumn() = New DataGridTextBoxColumn(31 - 1) {}
