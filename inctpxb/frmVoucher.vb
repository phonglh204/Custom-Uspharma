...
Public Class frmVoucher
    ...
    Public Sub Delete()
        ...
        ElseIf (Not ((StringType.StrCmp(Strings.Trim(Me.txtStatus.Text), "0", False) <> 0) And (StringType.StrCmp(Strings.Trim(Me.txtSo_buoc.Text), "2", False) = 0)) OrElse (ObjectType.ObjTst(Msg.Question(StringType.FromObject(modVoucher.oLan.Item("035")), 1), 1, False) = 0)) Then
            ...
            If VoucherCode = "PXI" Then
                str4 = ("stt_rec = '" & Strings.Replace(StringType.FromObject(modVoucher.tblMaster.Item(Me.iMasterRow).Item("stt_rec")), modVoucher.VoucherCode, "PNY", 1, -1, CompareMethod.Binary) & "'")
            Else
    ...
    Private Sub frmVoucher_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Me.InitInventory()
        Dim oCus As New DirLib(Me.txtMa_kh, Me.lblTen_kh, modVoucher.sysConn, modVoucher.appConn, "dmkh", "ma_kh", "ten_kh", "Customer", "1=1", True, Me.cmdEdit)
    End Sub
    ...
    Private Function GetIDItem(ByVal tblItem As DataView, ByVal sStart As String) As String
        ...
        Dim _stt_rec0 As Integer = 0
        Dim _stt_rec0max As Integer = 0
        Dim i As Integer = 0
        Do While (i <= num2)
            If (Not Information.IsDBNull(RuntimeHelpers.GetObjectValue(tblItem.Item(i).Item("stt_rec0")))) Then
                Try
                    _stt_rec0 = CInt(tblItem.Item(i).Item("stt_rec0"))
                    If _stt_rec0 > _stt_rec0max Then
                        _stt_rec0max = _stt_rec0
                    End If
            ...
            i += 1
        Loop
        Return Strings.Format(_stt_rec0max + 1, "0000")
    End Function
...
Private Sub InitializeComponent()
        ...
        Me.tbDetail.Location = New System.Drawing.Point(2, 144)
        Me.tbDetail.Name = "tbDetail"
        Me.tbDetail.SelectedIndex = 0
        Me.tbDetail.Size = New System.Drawing.Size(638, 248)
        ...
        Me.tpgDetail.Size = New System.Drawing.Size(630, 222)
        ...
        Me.grdDetail.Size = New System.Drawing.Size(633, 223)
        ...
        Me.tpgOther.Size = New System.Drawing.Size(630, 222)
        ...
        Me.lblMa_kho.Location = New System.Drawing.Point(2, 7)
        ...
        Me.lblOng_ba.Location = New System.Drawing.Point(2, 71)
        ...
        Me.txtOng_ba.Location = New System.Drawing.Point(88, 70)
        Me.txtOng_ba.Name = "txtOng_ba"
        Me.txtOng_ba.Size = New System.Drawing.Size(100, 20)
        Me.txtOng_ba.TabIndex = 3
        ...
        Me.lblMa_gd.Location = New System.Drawing.Point(2, 114)
        ...
        Me.txtMa_gd.Location = New System.Drawing.Point(88, 112)
        ...
        'lblTen_gd
        '
        Me.lblTen_gd.Location = New System.Drawing.Point(121, 116)
        ...
        Me.txtDien_giai.Location = New System.Drawing.Point(88, 91)
        ...
        Me.lblDien_giai.Location = New System.Drawing.Point(2, 93)
        ...
        Me.lblMa_khon.Location = New System.Drawing.Point(2, 28)
        ...
        Me.lblCustomer.Location = New System.Drawing.Point(2, 49)
        Me.lblCustomer.Name = "lblCustomer"
        Me.lblCustomer.Size = New System.Drawing.Size(65, 13)
        Me.lblCustomer.TabIndex = 81
        Me.lblCustomer.Tag = "L039"
        Me.lblCustomer.Text = "Khach hang"
        '
        'txtMa_kh
        '
        Me.txtMa_kh.BackColor = System.Drawing.Color.White
        Me.txtMa_kh.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper
        Me.txtMa_kh.Location = New System.Drawing.Point(88, 48)
        ...
        Me.lblTen_kh.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.lblTen_kh.Location = New System.Drawing.Point(192, 51)
        Me.lblTen_kh.Name = "lblTen_kh"
        Me.lblTen_kh.Size = New System.Drawing.Size(233, 15)
        Me.lblTen_kh.TabIndex = 83
        ...
        Me.tbgUpdateInv.Size = New System.Drawing.Size(630, 222)
        Me.tbgUpdateInv.TabIndex = 2
        Me.tbgUpdateInv.Text = "Kiểu phát hành"
        '
        ...
        Me.txtStt_rec_hd_update.Location = New System.Drawing.Point(140, 30)
        ...
        Me.lblTen_hd_update.Location = New System.Drawing.Point(255, 34)
        ...
        Me.Label13.Tag = ""
        Me.Label13.Text = "Cập nhật cho hóa đơn"
        '
        'Label12
        '
        ...
        Me.Label12.Location = New System.Drawing.Point(179, 11)
        ...
        Me.Label11.Tag = ""
        Me.Label11.Text = "Kiểu phát hành"
        '
        'txtLoai_hd_phathanh
        '
        ...
        Me.txtLoai_hd_phathanh.Location = New System.Drawing.Point(140, 7)
        ...
        If Fox.InList(oVoucher.cAction, New Object() {"New", "Edit"}) Then
            ...
            If (_date.ShowDialog = DialogResult.OK) Then
                ...
                Else
                    ...
                    Fill2Grid.Fill(modVoucher.sysConn, (Me.tblRetrieveMaster), grdFill, (tbs), (cols), "MRMaster")
                    ...
                    Fill2Grid.Fill(modVoucher.sysConn, (Me.tblRetrieveDetail), grdFill, (style), (cols), "MRDetail4Issue")
    ...
    Public Sub View()
        ...
        frmAdd.Controls.Add(gridformtran)
        Dim grdFill As DataGrid = gridformtran2
        Fill2Grid.Fill(modVoucher.sysConn, (modVoucher.tblMaster), grdFill, (tbs), (cols), "ITMaster")
        gridformtran2 = grdFill
        index = 0
        Do
            If (Strings.InStr(modVoucher.tbcDetail(index).Format, "0", CompareMethod.Binary) > 0) Then
        ...
        cols(2).Alignment = HorizontalAlignment.Right
        grdFill = gridformtran
        Fill2Grid.Fill(modVoucher.sysConn, (modVoucher.tblDetail), grdFill, (style), (cols), "ITDetail")
        gridformtran = grdFill
        index = 0
        Do
            If (Strings.InStr(modVoucher.tbcDetail(index).Format, "0", CompareMethod.Binary) > 0) Then
