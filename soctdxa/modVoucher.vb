...
Module modVoucher
    ...
    Public Sub main(ByVal CmdArgs As String())
        ...
        Sys.InitMessage(modVoucher.sysConn, modVoucher.oLan, "SOTran")
    ...
    Public Const SysID As String = "SOTran"
    Public tbcCharge As DataGridTextBoxColumn() = New DataGridTextBoxColumn(MaxColumns) {}
