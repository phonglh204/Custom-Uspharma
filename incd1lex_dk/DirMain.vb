...
Namespace incd1lex
    ...
    Friend NotInheritable Class DirMain
            ...
            Select Case nIndex
                Case 1
                    If Not Information.IsNothing(DirMain.oDirFormLib.GetClsreports.GetGrid.CurDataRow) Then
                        ...
                        oDirFormDetailLib.strSQLRunReports = ("spStockSummaryDetailLEx_dk" & DirMain.oxInv.xStore & str2)
        ...
        Public Shared Sub ShowReport()
            DirMain.strQuery = ("EXEC spStockSummaryByItemLot_dk" & DirMain.oxInv.xStore)
