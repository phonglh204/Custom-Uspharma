...
Namespace soctsq1
    Public Class frmPrint
        ...
        Private Sub frmPrint_Load(ByVal sender As Object, ByVal e As EventArgs)
            ...
            table = clsprint.InitComboReport(modVoucher.sysConn, cboReports, "SQTran")
            txtTitle.Text = table.Rows.Item(0).Item("rep_title")
        End Sub
        ...
        Private Sub InitializeComponent()
            ...
            Me.lblSo_lien.Size = New System.Drawing.Size(43, 13)
            ...
            Me.lblSo_ct_goc.Size = New System.Drawing.Size(86, 13)
        ...
        Private Sub cboReports_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboReports.SelectionChangeCommitted
            Dim selectedIndex As Integer = cboReports.SelectedIndex
            txtTitle.Text = table.Rows.Item(selectedIndex).Item("rep_title")
        End Sub
    End Class
End Namespace
