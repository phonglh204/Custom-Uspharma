...
Namespace inbk1
    Public Class frmFilter
        ...
        Private Sub frmDirInfor_Load(ByVal sender As Object, ByVal e As EventArgs)
            reportformlib.AddFreeFields(DirMain.sysConn, Me.tabReports.TabPages.Item(3), 14)
            reportformlib.SetRPFormCaption(Me, Me.tabReports, DirMain.oLan, DirMain.oVar, DirMain.oLen)

            Dim oCust As New vouchersearchlibobj(Me.txtMa_kh, Me.lblTen_kh, DirMain.sysConn, DirMain.appConn, "dmkh", "ma_kh", "ten_kh", "Customer", "1=1", True, Me.cmdCancel)
            ...
            Dim vouchersearchlibobj15 As New vouchersearchlibobj(Me.txtMa_khon, Me.lblTen_khon, DirMain.sysConn, DirMain.appConn, "dmkho", "ma_kho", "ten_kho", "Store", "1=1", True, Me.cmdCancel)
            ...
            Dim vouchersearchlibobj7 As New vouchersearchlibobj(Me.txtTk_vt2, Me.lblTen_Tk_vt2, DirMain.sysConn, DirMain.appConn, "dmtk", "tk", "ten_tk", "Account", "1=1", True, Me.cmdCancel)
            Dim vouchersearchlibobj8 As New vouchersearchlibobj(Me.txtNh_vt, New Label, DirMain.sysConn, DirMain.appConn, "Dmnhvt", "ma_nh", "ten_nh", "ItemGroup", "loai_nh=1", True, Me.cmdCancel)
            Dim vouchersearchlibobj9 As New vouchersearchlibobj(Me.txtNh_vt2, New Label, DirMain.sysConn, DirMain.appConn, "Dmnhvt", "ma_nh", "ten_nh", "ItemGroup", "loai_nh=2", True, Me.cmdCancel)
            Dim vouchersearchlibobj10 As New vouchersearchlibobj(Me.txtNh_vt3, New Label, DirMain.sysConn, DirMain.appConn, "Dmnhvt", "ma_nh", "ten_nh", "ItemGroup", "loai_nh=3", True, Me.cmdCancel)
            ...
            Dim vouchersearchlibobj13 As New vouchersearchlibobj(Me.txtMa_nx, Me.lblTen_nx, DirMain.sysConn, DirMain.appConn, "dmnx", "ma_nx", "ten_nx", "Reason", "1=1", True, Me.cmdCancel)
...
Private Sub InitializeComponent()
            ...
            Me.txtInvTo.Location = New Point(263, 36)
            ...
            Me.lblTen_vv.Location = New Point(264, 269)
            ...
            Me.Label3.Location = New Point(20, 269)
            ...
            Me.txtMa_vv.Location = New Point(160, 267)
            ...
            Me.txtNh_vt3.Location = New Point(366, 220)
            ...
            Me.txtNh_vt2.Location = New Point(263, 220)
            ...
            Me.tbgOther.Size = New Size(601, 342)
            ...
            Me.tbgOptions.Size = New Size(601, 342)
            ...
            Me.tbgFree.Size = New Size(601, 342)
            ...
            Me.tbgAdv.Size = New Size(601, 342)
            ...
            Me.tbgOrder.Size = New Size(601, 342)
            ...
            Me.grdOrder.Size = New Size(601, 344)
            ...
            Me.tbgTransCode.Size = New Size(601, 342)
            ...
            Me.grdTransCode.Size = New Size(601, 344)
            ...
            Me.lblTen_khon.Size = New Size(73, 16)
            Me.lblTen_khon.TabIndex = 63
            Me.lblTen_khon.Tag = "RF"
            Me.lblTen_khon.Text = "Ten kho hang"
            ...
            Me.Label10.Location = New Point(20, 107)
            Me.Label10.Name = "Label10"
            Me.Label10.Size = New Size(105, 16)
            Me.Label10.TabIndex = 64
            Me.Label10.Tag = "L115"
            Me.Label10.Text = "Ma kho dieu chuyen"
