...
Namespace inctpxa
    Public Class frmVoucher
        ...
        Private Sub frmVoucher_Load(ByVal sender As Object, ByVal e As EventArgs)
            ...
            AddHandler Me.colMa_vi_tri.TextBox.Enter, New EventHandler(AddressOf Me.WhenLocationEnter)
            AddHandler Me.colMa_lo.TextBox.Enter, New EventHandler(AddressOf Me.WhenLotEnter)
