...
Namespace inctpxa
    Public Class frmPrint
        ...
        Private Sub InitializeComponent()
            ...
            Me.lblTitle.Location = New Point(&H17, &H19)
            Me.lblTitle.Name = "lblTitle"
            Me.lblTitle.Size = New Size(&H2A, 13)
            Me.lblTitle.TabIndex = 5
            Me.lblTitle.Tag = "L501"
            Me.lblTitle.Text = "Tieu de"
            Me.lblSo_lien.AutoSize = True
            Me.lblSo_lien.Location = New Point(&H17, &H30)
            Me.lblSo_lien.Name = "lblSo_lien"
            Me.lblSo_lien.Size = New Size(&H2B, 13)
            ...
            Me.cmdPrint.Location = New Point(8, &H81)
            ...
            Me.cmdView.Location = New Point(&H54, &H81)
            ...
            Me.txtTitle.Location = New Point(&H9B, &H15)
            Me.txtTitle.Name = "txtTitle"
            Me.txtTitle.Size = New Size(&H1A5, 20)
            Me.txtTitle.TabIndex = 0
            Me.txtTitle.Text = "txtTieu_de"
            Me.lblSo_ct_goc.AutoSize = True
            Me.lblSo_ct_goc.Location = New Point(&H17, &H47)
            Me.lblSo_ct_goc.Name = "lblSo_ct_goc"
            Me.lblSo_ct_goc.Size = New Size(&H56, 13)
            Me.lblSo_ct_goc.TabIndex = &H13
            Me.lblSo_ct_goc.Tag = "L503"
            Me.lblSo_ct_goc.Text = "So chung tu goc"
            Me.txtSo_lien.Format = "##0"
            Me.txtSo_lien.Location = New Point(&H9B, &H2C)
            ...
            Me.txtSo_ct_goc.Location = New Point(&H9B, &H43)
            ...
            Me.cboReports.Location = New Point(&H9B, 90)
            Me.cboReports.Name = "cboReports"
            Me.cboReports.Size = New Size(300, &H15)
            Me.cboReports.TabIndex = 3
            Me.cboReports.Text = "cboReports"
            Me.lblMau_bc.AutoSize = True
            Me.lblMau_bc.Location = New Point(&H17, &H5E)
            Me.lblMau_bc.Name = "lblMau_bc"
            Me.lblMau_bc.Size = New Size(&H45, 13)
            Me.lblMau_bc.TabIndex = &H16
            ...
            Me.cmdClose.Location = New Point(&H20D, &H81)
            Me.cmdClose.Name = "cmdClose"
            Me.cmdClose.TabIndex = 6
            Me.cmdClose.Tag = "L507"
            Me.cmdClose.Text = "Quay ra"
            Me.AutoScaleBaseSize = New Size(5, 13)
            Me.ClientSize = New Size(&H260, &H9D)
