...
Namespace incd1lex
    ...
    Friend NotInheritable Class DirMain
            ...
            Select Case nIndex
                Case 1
                    If Not Information.IsNothing(DirMain.oDirFormLib.GetClsreports.GetGrid.CurDataRow) Then
                        ...
                        oDirFormDetailLib.strSQLRunReports = ("fs_StockSummaryDetailLEx" & DirMain.oxInv.xStore & str2)
        ...
        Public Shared Sub ShowReport()
            DirMain.strQuery = ("EXEC fs_StockSummaryByItemLot" & DirMain.oxInv.xStore)
            ...
            'Msg.Alert(ds.Tables(0).Rows.Count)
            'ds = Nothing
