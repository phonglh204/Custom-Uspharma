...
Namespace zTongHopKeHoachNam
    Module DirMain
        ...
        Public Sub ShowReport()
            Try
                Dim str As String = "EXEC zKeHoachNam_Quy " + Sql.ConvertVS2SQLType(DirMain.fPrint.txtNam.Value, "")
                str += ", " + Sql.ConvertVS2SQLType(DirMain.fPrint.txtQuarter.Text, "")
                ...
                'ds.WriteXmlSchema("D:\LocalCustomer\Uspharma4.0\Rpt\zTongHopKeHoachNam.xsd")
