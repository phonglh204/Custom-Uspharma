...
Public Class frmFilter
    ...
    Private Sub frmDirInfor_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim vouchersearchlibobj As New vouchersearchlibobj(Me.txtLoai_ts, Me.lblTen_loai_ts, DirMain.sysConn, DirMain.appConn, "dmplts", "ma_loai", "ten_loai", "FAType", "1=1", True, Me.cmdCancel)
        Dim vouchersearchlibobj6 As New vouchersearchlibobj(Me.txtMa_bpsd, Me.lblTen_bpsd, DirMain.sysConn, DirMain.appConn, "dmbpts", "ma_bp", "ten_bp", "FADept", "1=1", True, Me.cmdCancel)
        Dim vouchersearchlibobj2 As New vouchersearchlibobj(Me.txtNh_ts1, Me.lblTen_nh_ts1, DirMain.sysConn, DirMain.appConn, "dmnhts", "ma_nh", "ten_nh", "FAGroup", "loai_nh=1", True, Me.cmdCancel)
        Dim vouchersearchlibobj3 As New vouchersearchlibobj(Me.txtNh_ts2, Me.lblTen_nh_ts2, DirMain.sysConn, DirMain.appConn, "dmnhts", "ma_nh", "ten_nh", "FAGroup", "loai_nh=2", True, Me.cmdCancel)
        Dim vouchersearchlibobj4 As New vouchersearchlibobj(Me.txtNh_ts3, Me.lblTen_nh_ts3, DirMain.sysConn, DirMain.appConn, "dmnhts", "ma_nh", "ten_nh", "FAGroup", "loai_nh=3", True, Me.cmdCancel)
