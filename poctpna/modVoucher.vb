...
Module modVoucher
    ...
    Public Sub main(ByVal CmdArgs As String())
        ...
        Sys.InitMessage(modVoucher.sysConn, modVoucher.oLan, "PVTran")
    ...
    Public Const SysID As String = "PVTran"
    Public tbcCharge As DataGridTextBoxColumn() = New DataGridTextBoxColumn(&H1F - 1) {}
    Public tbcDetail As DataGridTextBoxColumn() = New DataGridTextBoxColumn(&H1F - 1) {}
    Public tbcOther As DataGridTextBoxColumn() = New DataGridTextBoxColumn(&H1F - 1) {}
